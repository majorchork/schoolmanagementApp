...
func TestPrincipal_Admits(t *testing.T) {
	var Testadmits = []struct {
		...
		{Principal{"Bob", 34, []string{"Phd", "Bsc", "Msc"}}, 15, "Oreva", "Congratulations You have Gained Admission"},
		{Principal{"Bob", 34, []string{"Phd", "Bsc", "Msc"}}, 9, "Debs", "Not Admitted, Applicant is too Young for JSS1"},
	}
...
func TestPrincipal_Expels(t *testing.T) {
	var TestExpel = []struct {
		...
		{Principal{"Bob", 34, []string{"Phd", "Bsc", "Msc"}}, 15, "student expelled for poor grades"},
		{Principal{"Bob", 34, []string{"Phd", "Bsc", "Msc"}}, 4, "student is advised to withdraw"},
		{Principal{"Bob", 34, []string{"Phd", "Bsc", "Msc"}}, 1, "student is advised to put in more effort"},
		{Principal{"Bob", 34, []string{"Phd", "Bsc", "Msc"}}, 0, "good student keep it up"},
	}
